...
const ServiceCard = ({ service }) => {
  return (
    <div
      key={service.id}
      className="flex flex-col justify-around w-full bg-white p-4 h-80 hover:shadow-2xl transition duration-200 rounded-xl shadow-lg"
    >
      <div className="text-center flex justify-center ">
        <p className="text-blue-900 text-4xl rounded-full bg-blue-100 p-4">
          {service.icon}
        </p>
      </div>
