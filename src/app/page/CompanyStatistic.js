const CompanyStatistic = () => {
    return (
      <div className=" h-auto py-12 flex justify-center px-8">
        <div className="w-full py-16 bg-blue-100 flex flex-col md:flex-row justify-around items-center rounded-4xl ">
