...
const CompanyStatistic = () => {
  return (
    <div className="h-auto py-12 flex justify-center px-5 lg:px-8">
      <div className="w-full h-100 md:h-auto md:py-16 bg-blue-100 grid grid-cols-2 md:grid-cols-4 items-center rounded-4xl ">
        <div className="flex flex-col lg:flex-row justify-center items-center text-semibold gap-2 border-r border-gray-300">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center  text-semibold gap-2 md:border-r border-gray-300">
          <div className="bg-white rounded-full p-2">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center  text-semibold gap-2">
          <div className="bg-white rounded-full p-2">
